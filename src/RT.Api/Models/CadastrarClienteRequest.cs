...
{
    /// <summary>
    /// Representa uma requisição para cadastrar cliente
    /// </summary>
    public class CadastrarClienteRequest
    {
        ...
        /// </summary>
        public IEnumerable<CadastrarClienteEnderecoDto> Enderecos { get; set; }

        /// <summary>
        /// Responsável por transformar Requisiçao da aplicaçao em commando.
        /// </summary>
        /// <returns></returns>
        public CadastrarClienteCommand Map()
        {
            return new CadastrarClienteCommand(Nome, Rg, Cpf, DataNascimento, Telefone, Email, Empresa, Enderecos);
        }
